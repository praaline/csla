//-----------------------------------------------------------------------
// <copyright file="MobileSortedSet.cs" company="Marimer LLC">
//     Copyright (c) Marimer LLC. All rights reserved.
//     Website: https://cslanet.com
// </copyright>
// <summary>Implements a SortedSet that is serializable using</summary>
//-----------------------------------------------------------------------
using System;
...
{
  /// <summary>
  /// Implements a SortedSet that is serializable using
  /// the SerializationFormatterFactory.GetFormatter().
  /// </summary>
  /// <typeparam name="T">
  /// Type of object contained in the SortedSet.
  /// </typeparam>
  [Serializable]
  public class MobileSortedSet<T> : SortedSet<T>, IMobileObject
  {
    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    public MobileSortedSet() : base() { }

    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="comparer">Equality comparer to use.</param>
    public MobileSortedSet(IComparer<T> comparer) : base(comparer) { }

    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="collection">Data to add to set.</param>
    public MobileSortedSet(IEnumerable<T> collection) : base(collection) { }
    ...
    /// <param name="collection">Data to add to set.</param>
    /// <param name="comparer">Equality comparer to use.</param>
    public MobileSortedSet(IEnumerable<T> collection, IComparer<T> comparer) : base(collection, comparer) { }
