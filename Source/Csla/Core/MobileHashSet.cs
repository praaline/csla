//-----------------------------------------------------------------------
// <copyright file="MobileHashSet.cs" company="Marimer LLC">
//     Copyright (c) Marimer LLC. All rights reserved.
//     Website: https://cslanet.com
// </copyright>
// <summary>Implements a HashSet that is serializable using</summary>
//-----------------------------------------------------------------------
using System;
...
{
  /// <summary>
  /// Implements a HashSet that is serializable using
  /// the SerializationFormatterFactory.GetFormatter().
  /// </summary>
  /// <typeparam name="T">
  /// Type of object contained in the HashSet.
  /// </typeparam>
  [Serializable]
  public class MobileHashSet<T> : HashSet<T>, IMobileObject
  {
    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    public MobileHashSet() : base() { }
    
    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="collection">Data to add to set.</param>
    public MobileHashSet(IEnumerable<T> collection) : base(collection) { }

    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="comparer">Equality comparer to use.</param>
    public MobileHashSet(IEqualityComparer<T> comparer) : base(comparer) { }

#if (NET47_OR_GREATER || NETSTANDARD2_1_OR_GREATER)
    /// <summary>
    /// Creates an instance of the type.
    /// </summary>
    /// <param name="capacity">Capacity of the set.</param>
    public MobileHashSet(Int32 capacity) : base(capacity) { }
#endif
    ...
    /// <param name="collection">Data to add to set.</param>
    /// <param name="comparer">Equality comparer to use.</param>
    public MobileHashSet(IEnumerable<T> collection, IEqualityComparer<T> comparer) : base(collection, comparer) { }
    ...
    /// <param name="capacity">Capacity of the set.</param>
    /// <param name="comparer">Equality comparer to use.</param>
    public MobileHashSet(Int32 capacity, IEqualityComparer<T> comparer) : base(capacity, comparer) { }
#endif    
