//-----------------------------------------------------------------------
// <copyright file="MobileSortedList.cs" company="Marimer LLC">
//     Copyright (c) Marimer LLC. All rights reserved.
//     Website: https://cslanet.com
// </copyright>
// <summary>Defines a sorted list that can be serialized through</summary>
//-----------------------------------------------------------------------
...
{
  /// <summary>
  /// Defines a sorted list that can be serialized through
  ...
  [Serializable()]
  public class MobileSortedList<K, V> : SortedList<K, V>, IMobileObject where K : notnull
  {
    ...
    /// are copied to the new list.
    /// </summary>
    /// <param name="dict">Source list.</param>
    public MobileSortedList(IDictionary<K, V> dict)
      : base(dict)
    {
      DetermineTypes();
    }
    ...
    /// <param name="dict">Source list.</param>
    /// <param name="comparer">The comparer to use when comparing keys.</param>
    public MobileSortedList(IDictionary<K, V> dict, IComparer<K> comparer)
      : base(dict, comparer)
    {
      DetermineTypes();
    }
    ...
    /// list contains the specified key
    /// value.
    /// </summary>
